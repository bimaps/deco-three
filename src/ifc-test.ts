...
let src = path.join(
  __dirname,
  "../_ifc_sources/0912106-02windows_placement_inside_wall_all_1.ifc"
);
let dest = path.join(
  __dirname,
  "../ignored/0912106-02windows_placement_inside_wall_all_1.obj"
);
...
try {
  ...
  console.log("ERROR");
  console.log(
    `Destination file "${dest}" exists. Remove or rename before to try again.`
  );
  console.log("------");
  process.exit();
} catch (error) {
