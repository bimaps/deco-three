...
router.get('/report' + ControllerMiddleware.getOneRoute(), AppMiddleware.fetchWithPublicKey, reportController.getOne());

router.post('/report' + ControllerMiddleware.postRoute(), AppMiddleware.fetchWithPublicKey, reportController.post());

router.put('/report' + ControllerMiddleware.putRoute(), AppMiddleware.fetchWithPublicKey, reportController.put());

router.delete('/report' + ControllerMiddleware.deleteRoute(), AppMiddleware.fetchWithPublicKey, reportController.delete());
...
router.get(ControllerMiddleware.getOneRoute(), AppMiddleware.fetchWithPublicKey, configController.getOne());
...
router.delete(ControllerMiddleware.deleteRoute(), AppMiddleware.fetchWithPublicKey, configController.delete());
